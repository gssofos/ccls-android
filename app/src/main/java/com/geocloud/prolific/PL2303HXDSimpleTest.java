...
/*
        ...
        */
        ...
        /*
    	Toast.makeText(this, "WRITEBUF_SIZE : " + mSerial.WRITEBUF_SIZE, Toast.LENGTH_SHORT)
			.show();
...
/*
    ...
    */
    ...
    private void writeDataToSerial() {
        ...
        String strWrite = etWrite.getText().toString() + Character.toString((char) 13)+Character.toString((char) 10);
        /*
